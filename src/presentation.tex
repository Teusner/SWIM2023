        ...
        \begin{frame}{Log control}
            ...
            \begin{minipage}{0.5\textwidth}
                ...
                \begin{block}<3->{Angular velocity w}
                    Link between $\mathbf{\color{RoyalPurple}w}$ and $\mathbf{\color{RoyalPurple}R_w}$~\cite{jaulin2019mobile}.
                    \begin{align}
                ...
                \begin{figure}
                    ...
                    \begin{tikzpicture}
                        \begin{axis}[
                                ...
                                xlabel=$\theta$,
                                ylabel=$Log(A(\theta))$,
                                xmin=-10, xmax=10, % x scale
                                ymin=-4, ymax=4, % y scale
                                domain=-9:9, samples=100,
                            ]
