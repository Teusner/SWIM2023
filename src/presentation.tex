                    ...
                    \begin{figure}
                        ...
                        \begin{tikzpicture}[
                            ...
                            \karnaughmaptab{3}{$f(a,b,c)$}{{$a$}{$b$}{$c$}}{0110 0011}{
                                ...
                                \draw<5-6>[RoyalBlue,thick] (2\kmunitlength,0) -- (3\kmunitlength,0);
                                \draw<5-6>[RoyalBlue,thick] (2\kmunitlength,\kmunitlength) -- (3\kmunitlength,\kmunitlength);
                                \draw<5-6>[RoyalBlue,thick] (2\kmunitlength,2\kmunitlength) -- (3\kmunitlength,2\kmunitlength);
                ...
                \begin{figure}
                    ...
                    \begin{tikzpicture}[
                        ...
                        \karnaughmaptab{3}{$f(a,b,c)$}{{$a$}{$b$}{$c$}}{0110 0011}{
                            ...
                            % dBnA
                            \draw<2->[alt=<2>{RoyalBlue}{Dandelion},,thick] (2\kmunitlength,0) -- (2\kmunitlength,\kmunitlength);
                            \draw<2->[alt=<2>{RoyalBlue}{Dandelion},thick] (4\kmunitlength,0) -- (4\kmunitlength,\kmunitlength);
                            % dCnA
                            \draw<3->[alt=<3>{RoyalBlue}{Dandelion},thick] (\kmunitlength,\kmunitlength) -- (\kmunitlength,2\kmunitlength);
                            \draw<3->[alt=<3>{RoyalBlue}{Dandelion},thick] (3\kmunitlength,\kmunitlength) -- (3\kmunitlength,2\kmunitlength);
                            % dAnBn~C
                            \draw<4->[alt=<4>{RoyalBlue}{Dandelion},thick] (3\kmunitlength,0) -- (4\kmunitlength,0);
                            \draw<4->[alt=<4>{RoyalBlue}{Dandelion},thick] (3\kmunitlength,\kmunitlength) -- (4\kmunitlength,\kmunitlength);
                            % dAn~BnC
                            \draw<5->[alt=<5>{RoyalBlue}{Dandelion},thick] (\kmunitlength,\kmunitlength) -- (2\kmunitlength,\kmunitlength);
                            \draw<5->[alt=<5>{RoyalBlue}{Dandelion},thick] (\kmunitlength,2\kmunitlength) -- (2\kmunitlength,2\kmunitlength);
                        }
                    \end{tikzpicture}
